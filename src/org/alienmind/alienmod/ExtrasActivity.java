...
public class ExtrasActivity extends ListActivity {
	String[] actions;
	String[] descriptions;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		actions      = getResources().getStringArray(R.array.extra_actions_array);
		descriptions = getResources().getStringArray(R.array.extra_descriptions_array);
